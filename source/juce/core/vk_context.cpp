...
// --- Getters ---
VkDevice VKContext::get_device() const { return m_device; }
VkPhysicalDevice VKContext::get_physical_device() const { return m_physical_device; }
VkQueue VKContext::get_graphics_queue() const { return m_graphics_queue; }
VkQueue VKContext::get_present_queue() const { return m_present_queue; }
VkSurfaceKHR VKContext::get_surface() const { return m_surface; }
VkCommandPool VKContext::get_command_pool() const { return m_command_pool; }
uint32_t VKContext::get_graphics_queue_family() const { return m_graphics_queue_family; }
uint32_t VKContext::get_present_queue_family() const { return m_present_queue_family; }
VKContext::SwapchainSupportDetails VKContext::get_swapchain_support() const { return query_swapchain_support(m_physical_device); }
