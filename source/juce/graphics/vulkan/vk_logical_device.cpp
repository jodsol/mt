...
namespace juce
{
vk_logical_device::vk_logical_device(VkInstance instance, VkSurfaceKHR surface) :
    m_surface(surface)
{
...
void vk_logical_device::create_device(VkInstance instance, VkSurfaceKHR surface)
{
...
uint64_t vk_logical_device::get_gpu_available_vram_byte(const VkPhysicalDeviceMemoryProperties& mem)
{
	uint64_t mem_size = 0;
...
bool vk_logical_device::is_gpu_supported_surface(VkPhysicalDevice gpu, const VkSurfaceKHR surface)
{
	if(!surface)
		return true;
...
bool vk_logical_device::choose_physical_device(VkInstance instance, VkSurfaceKHR surface, vk_physical_device* pp_gpu)
{
...
uint32_t vk_logical_device::transfer_queue_family_index() const
{
...
const VkQueue vk_logical_device::graphics_queue() const
{
	return m_graphics_queue;
}

const VkQueue vk_logical_device::present_queue() const
{
	return m_graphics_queue;
}

const VkQueue vk_logical_device::compute_queue() const
{
	return m_compute_queue;
}

const VkQueue vk_logical_device::transfer_queue() const
{
	return m_compute_queue;
}

const VkSurfaceKHR vk_logical_device::surface() const
{
	return m_surface;
}

const vk_physical_device* vk_logical_device::get_gpu() const
{
	return &m_gpu;
}

void vk_logical_device::wait_for_gpu_idle()
{
	VK(vkDeviceWaitIdle(handle()));
}

void vk_logical_device::create_logical_device(VkSurfaceKHR surface)
{
